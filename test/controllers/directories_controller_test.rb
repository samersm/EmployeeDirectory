...
class DirectoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post directories_url, params: { directory: { dept: @directory.dept, ext: @directory.ext, name: @directory.name, note: @directory.note } }
    end
  ...
  test "should update directory" do
    patch directory_url(@directory), params: { directory: { dept: @directory.dept, ext: @directory.ext, name: @directory.name, note: @directory.note } }
